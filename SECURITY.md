...
Replace this section with the supported versions for `mcpperm`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `mcpperm` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in mcpperm.
